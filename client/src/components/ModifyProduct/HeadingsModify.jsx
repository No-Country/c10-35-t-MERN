  ...
  return (
    ...
    <div className='flex-none order-1 grow-0 md:mt-3'>
        ...
        <div className='w-373 h-43  mt-2 top-31 left-0 px-0 py-4 gap-3 flex flex-row items-center  flex-none order-1 grow-0 md:pt-8  '>
            ...
            <p className=' w-271 h-43 left-l52 flex items-end font-primaria font-normal text-3xl md:top-0.5 md:w-178 md:h-31 md:flex-none md:order-none md:grow-0  md:font-secundaria md:text-2xl md:font-bold md:ml-64 md:mt-0'>
                Modificar Producto
            </p>
