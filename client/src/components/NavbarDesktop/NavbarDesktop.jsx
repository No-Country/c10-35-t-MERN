...
export default function NavbarDesktop() {
    return (
        <nav className='absolute h-screen w-130 top-0 left-0 z-50 max-md:hidden lg:block'>
            <div className='h-full text-white bg-secundario'>
                ...
                <div className='h-navbar flex flex-col justify-between'>
                    <div>
                        <NavLink to='/inventario' className={({ isActive }) =>
                            isActive ? 'w-full h-20 bg-acento2 text-acento [&>button]:bg-acento2' : ''
                        }>
                        ...
                        <NavLink to='/crear-producto' className={({ isActive }) =>
                            isActive ? 'w-full h-20 bg-acento2 text-acento [&>button]:bg-acento2' : ''
                        }>
                    ...
                    <div>
                        ...
                        <NavLink to='/configuración' className={({ isActive }) =>
                            isActive ? 'w-full h-20 bg-acento2 text-acento [&>button]:bg-acento2' : ''
                        }>
                            <button className='group flex flex-col items-center justify-center w-full h-20 py-2 transition duration-200 ease-in-out font-secundaria border-b focus:bg-acento2'>
