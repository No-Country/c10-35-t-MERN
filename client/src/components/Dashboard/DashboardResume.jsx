...
export default function DashboardResume() {
    ...
    return (
    <section className='mt-8 bg-primario rounded-t-3xl font-secundaria p-4 pb-24'>
        ...
        </h3>
        {
            ...
            ? dashboardResumeProducts.map((product) => (
                <section key={product.id} className='shadow-sombra my-2 rounded-xl flex items-center p-2.5 w-w343 h-h72 bg-white'>
                    <img src={product.img} alt='Ícono de crear producto' className='flex-1 mr-2 w-16 h-11 object-stretch rounded border-2 border-acento2'/>
